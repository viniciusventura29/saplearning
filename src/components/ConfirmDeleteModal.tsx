        ...
        <div className="relative bg-white rounded-lg shadow">
          ...
          <div className="p-6 space-y-6 flex flex-col">
            <div className="flex flex-col gap-2">
              ...
              <p className="mt-10">
                To delete this write the topic title{" "}
                <span className="text-gray-600 italic">("{title}")</span> below
              </p>
              <input
                id="topicTitle"
          ...
          <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b ">
            <button
              ...
              data-modal-hide="defaultModal"
              type="button"
              className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:bg-red-200"
              onClick={(e) => {
                topicDelete.mutate();
                e.preventDefault();
              }}
